...
object D01CalorieCounting extends App {
  ...
  // Test Case
  AocFileOps
    .readStringInputFromFile("src/main/resources/aoc2022/2022D01P1TestInput.lst") match {
  ...
  // Problem - Part 1
  AocFileOps
    .readStringInputFromFile("src/main/resources/aoc2022/2022D01P1Input.lst") match {
